---
title: "Vancouver Datajam 2020 - Git and Github workshop"
...
*Attribution - much of this presentation is derived the workshop that Tiffany Timbers gave to RLadies, which is derived from Jenny Bryan's "Happy with and GitHub for the useR" book*
---
class: center, middle
...
---
# Adding & commiting changes to version controlled filesfcv 
...
Add your name as the author to the document (e.g., "author: Raissa")
...
---
# What if I make more changes directly or if my collaborators have pushed their changes on Github? 
...
![:scale 60%](git-branches-merge.png)

* Great when working on separate tasks
 + Multiple people can work on the same branch

* Noone is breaking the main code that everyone else is using


*source: “Noble desktop”*</br> 
...
```
  git checkout -b myfuntask
  
```
* This will copy everything from the master branch to your own branch

* The master branch will be left untouched
...
* A pull request is Github speak for asking to include your changes to the main branch

* There's some good documentation here on Github.
...
* This will change all the files back to the way they are on the master branch

* If other people are working on the master branch, make sure you "pull" first.
